...
feature_cols = ['Longitude', 'Latitude', 'Crime type']
...
categorical_features = ['Crime type']
...
base_regressor = GradientBoostingRegressor(n_estimators=500, random_state=42, verbose=1)
