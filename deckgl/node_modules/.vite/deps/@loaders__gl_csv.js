...
var ChunkStreamer = class {
  constructor(config) {
    ...
    __publicField(this, "_input", null);
    __publicField(this, "_baseIndex", 0);
    __publicField(this, "_partialLine", "");
    __publicField(this, "_rowCount", 0);
    __publicField(this, "_start", 0);
    __publicField(this, "isFirstChunk", true);
    __publicField(this, "_completeResults", {
      data: [],
      errors: [],
      meta: {}
    });
...
var ParserHandle = class {
  constructor(_config) {
    ...
    __publicField(this, "_rowCounter", 0);
    ...
    __publicField(this, "_delimiterError", false);
...
var AsyncIteratorStreamer = class extends ChunkStreamer2 {
  constructor(config = {}) {
    super(config);
    __publicField(this, "textDecoder", new TextDecoder(this._config.encoding));
  }
...
// node_modules/@loaders.gl/csv/dist/lib/encoders/encode-csv.js
...
// node_modules/@loaders.gl/csv/dist/csv-writer.js
var CSVWriter = {
  id: "csv",
  version: "latest",
  module: "csv",
...
@loaders.gl/csv/dist/papaparse/papaparse.js:
  ...
  *)
*/
//# sourceMappingURL=@loaders__gl_csv.js.map
